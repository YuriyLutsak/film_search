...
mixin _$Movie {
  ...
  String? get poster_path =>
      throw _privateConstructorUsedError; // while it doesnt was nullable we have:
...
// while it doesnt was nullable we have:
// Error: Expected a value of type 'String', but got one of type 'Null'
...
abstract class _Movie implements Movie {
  ...
  @override
  String? get poster_path;
  @override // while it doesnt was nullable we have:
// Error: Expected a value of type 'String', but got one of type 'Null'
  List<Genre>? get genres;
  @override
  @JsonKey(ignore: true)
